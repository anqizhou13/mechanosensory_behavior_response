...
'/Volumes/TOSHIBA/t2/FCF_attP2-40@UAS_Abeta40_117/p_4_60s1x30s0s#p_4_120s10x2s8s#n#n/exp3/';
...
'/Volumes/TOSHIBA/t2/GMR_SS00888@w1118/p_4_60s1x30s0s#p_4_120s10x2s8s#n#n/exp3/';
}

newXticklabel = {'attP2-40>Ab1-40','SS00739>Ab1-40','SS00888>Ab1-40','SS00918>Ab1-40'};
testGeno = 'attP2-40_Ab40'; % the genotype that is being graphed against control

%%
for i = 1:length(adresses)
file = dir(fullfile(adresses{i}, 'dataFiles/trx_concatenated.mat'));
L = load([file.folder '/' file.name]);
genotypes{i,:} = L.allAmplitudes;
end
...
root_folder = '/Volumes/TOSHIBA/MATLAB/trx/box_plots_amplitudes/';
