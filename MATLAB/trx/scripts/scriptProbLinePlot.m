...
% color = [[0,0,0];[0,0,0.2];[0.1,0,0.7];[0.1,0.2,1]]; % B2 dark blue
 color = [[0,0,0];[0.7,0.7,0.7];[1,0.1,0.6];[1,0.7,0.8]]; % Hb pink
%color = [[0,0,0];[0.2,0,0.1];[1,0.5,0.1];[1,0.7,0.2]]; % G2 orange

testGeno = 'attP2-40_SS00888_0-120s'; % the genotype that is being graphed against control
whichAb = 'Ab1-40+Ab1-42';
...
file = dir(fullfile(adresses{i}, 'dataFiles/probabilitiesovertime.mat'));
