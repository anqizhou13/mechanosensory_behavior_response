...
Base.isempty(track::Track) = isempty(track.states)
...
coerce(::Type{Symbol}, a::String) = Symbol(a)
coerce(::Type{Symbol}, a::Vector{String}) = Symbol.(a)
coerce(::Type{String}, a::Symbol) = string(a)
coerce(::Type{String}, a::Vector{Symbol}) = string.(a)
